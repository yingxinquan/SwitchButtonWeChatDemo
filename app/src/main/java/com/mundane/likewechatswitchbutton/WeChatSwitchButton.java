...
public class WeChatSwitchButton extends View implements View.OnClickListener {
	...
	public WeChatSwitchButton(Context context) {
		this(context, null);
	}

	public WeChatSwitchButton(Context context, @Nullable AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public WeChatSwitchButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
	...
	public interface OnCheckedChangeListener {
		void onCheckedChanged(WeChatSwitchButton buttonView, boolean isChecked);
	}
